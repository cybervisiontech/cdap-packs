...
package co.cask.lib.etl.transform.script;
 ...
 * of {@link co.cask.lib.etl.transform.schema.ScriptableSchemaMapping}.
 *
 * Provides functions (lookup, lookupInt, etc.) to query the provided
 * {@link co.cask.lib.etl.dictionary.DictionaryDataSet}.
 */
