...
public class ETLMapReduce extends AbstractMapReduce {
   ...
   * The default implementation is using program runtime argument {@link com.continuuity.lib.etl.Constants.Batch.Transformation#ARG_TRANSFORMATION_TYPE}
   * to get the name of
   ...
   * The default implementation is using program runtime argument {@link com.continuuity.lib.etl.Constants.Batch.Source#ARG_SOURCE_TYPE} to get
   ...
   * The default implementation is using program runtime argument {@link com.continuuity.lib.etl.Constants.Batch.Sink#ARG_SINK_TYPE} to get the
   * name of a class implementing sink. If this method is not overridden this runtime argument is required
   * @param context instance of {@link MapReduceContext}
   * @return instance of {@link com.continuuity.lib.etl.batch.sink.MapReduceSink} to be used as sink
   * @throws Exception
   */
