...
import co.cask.cdap.packs.etl.realtime.source.MetadataSource;
import co.cask.cdap.packs.etl.transform.IdentityTransformation;

public class RealtimeETLToDictionaryConfiguredWithCode extends RealtimeETL {
  @Override
  protected void configure(Configurer configurer) {
    ...
    configurer.setSink(new DictionarySink("myDict", "fname"));
  }
}